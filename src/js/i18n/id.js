...
ui_instr_single_title:'INSTRUKSI DEPLOYMENT — Satu Akun',
            ...
            ui_iac_check_label:'Pelanggan mengelola resource dengan Terraform (atau IaC lain)',
            ui_iac_reminder_title:'🏗️ Pengingat — Anda menandai pelanggan ini menggunakan Terraform / IaC',
            ui_iac_drift:'Rekonsiliasi default_tags/tags_all Terraform secara diam-diam menghapus tag map-migrated pada apply berikutnya (tag yang tidak dideklarasikan dalam IaC akan dihapus). Minta pelanggan menambahkan ignore_tags { keys = ["map-migrated"] } ke blok Terraform AWS provider, atau mendeklarasikan tag tersebut dalam IaC mereka. CloudFormation umumnya membiarkan tag yang diterapkan di luar IaC. Tagger mendeteksi penghapusan tag di luar IaC dan memicu alarm CloudWatch berisi perbaikan ini (hanya peringatan — tidak pernah menandai ulang secara otomatis).',
