...
ui_instr_single_title:'HƯỚNG DẪN TRIỂN KHAI — Một tài khoản',
            ...
            ui_iac_check_label:'Khách hàng quản lý resource bằng Terraform (hoặc IaC khác)',
            ui_iac_reminder_title:'🏗️ Nhắc nhở — bạn đã đánh dấu khách hàng này dùng Terraform / IaC',
            ui_iac_drift:'Việc đồng bộ default_tags/tags_all của Terraform sẽ âm thầm xóa tag map-migrated ở lần apply tiếp theo (tag không được khai báo trong IaC sẽ bị gỡ). Hãy hướng dẫn khách hàng thêm ignore_tags { keys = ["map-migrated"] } vào khối Terraform AWS provider, hoặc khai báo tag này trong IaC của họ. CloudFormation thường giữ nguyên các tag được gắn ngoài luồng. Trình gắn tag phát hiện việc xóa tag ngoài luồng và phát cảnh báo CloudWatch kèm cách khắc phục này (chỉ cảnh báo — không bao giờ tự động gắn lại tag).',
