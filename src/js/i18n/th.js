...
ui_instr_single_title:'คำแนะนำการติดตั้ง — บัญชีเดียว',
            ...
            ui_stackset_bucket_note:'การติดตั้งนี้จะสร้าง S3 bucket ชั่วคราว (auto-map-tagger-{account-id}-{region}) เพื่อจัดเก็บ CloudFormation template สำหรับ StackSet โดย bucket จะถูกเก็บไว้หลังการติดตั้ง เนื่องจาก StackSet ต้องการสำหรับการติดตั้งในบัญชีใหม่ที่เข้าร่วมองค์กรในอนาคต',
            warn_no_us_east_1_global:'⚠️ ไม่มี us-east-1 ในภูมิภาคที่คุณเลือก บริการระดับโลก (CloudFront, Route 53, Global Accelerator, Network Firewall, Direct Connect, App Mesh, Cloud Map) จะสร้างเหตุการณ์ CloudTrail เฉพาะใน us-east-1 เท่านั้น และจะไม่ถูกติดแท็กหากไม่ได้รวม us-east-1 โปรดเพิ่ม us-east-1 หากคุณมีทรัพยากรบริการระดับโลกที่ต้องการแท็กเพื่อรับเครดิต MAP',
            ...
            ui_prereq_title:'ข้อกำหนดเบื้องต้น', ui_prereq_subtitle:'deploy.sh ที่สร้างขึ้นจะตรวจสอบสิ่งเหล่านี้โดยอัตโนมัติก่อนติดตั้ง:',
            ...
            ui_scp_intro:'หากองค์กรของคุณใช้ SCP โปรดตรวจสอบสิ่งต่อไปนี้ก่อนติดตั้ง:',
            ui_deploy_instructions:'คำแนะนำการติดตั้ง',
            ...
            ui_scp_mandatory:'SCP บังคับติด Tag — หากSCP กำหนดให้ต้องมี Tag ตั้งแต่ตอนสร้าง Resource โซลูชันนี้จะไม่สามารถตอบสนองข้อกำหนดดังกล่าวได้ (Tag ถูกนำไปใช้ 60-90 วินาทีหลังสร้าง) โปรดยกเว้น Tag key map-migrated จากการบังคับใช้หรือกำหนดระยะเวลาผ่อนผัน',
            ui_iac_title:'🏗️ ใช้ Terraform / IaC อยู่หรือไม่?',
            ui_iac_check_label:'Resource ในสภาพแวดล้อมนี้จัดการด้วย Terraform (หรือ IaC อื่นๆ)',
            ui_iac_reminder_title:'🏗️ คำเตือน — การติดตั้งนี้ถูกระบุว่าเป็นสภาพแวดล้อมที่จัดการด้วย Terraform / IaC',
            ui_iac_drift:'การปรับสถานะ default_tags/tags_all ของ Terraform จะลบ Tag map-migrated แบบเงียบๆ ในการ apply ครั้งถัดไป (Tag ที่ไม่ได้ประกาศใน IaC จะถูกลบ) เพิ่ม ignore_tags { keys = ["map-migrated"] } ในบล็อก Terraform AWS provider ของคุณ หรือประกาศ Tag นี้ใน IaC ของคุณ โดยทั่วไป CloudFormation จะไม่ลบ Tag ที่ติดจากภายนอก ตัวติด Tag จะตรวจจับการลบ Tag จากภายนอกและแจ้งเตือนผ่าน CloudWatch alarm พร้อมวิธีแก้ไขนี้ (แจ้งเตือนเท่านั้น — จะไม่ติด Tag ใหม่อัตโนมัติ)',
            ...
            err_mpe_derived_length:"สำหรับภูมิภาคและตัวเลือกที่เลือก MAP ID มีความยาวได้สูงสุด {max} ตัวอักษร — ชื่อบทบาท AWS IAM ที่สร้างจาก ID นี้จำกัดที่ 64 ตัวอักษร",
            ...
            ui_update_changeset_note:'ก่อนนำไปใช้ upgrade.sh จะสร้าง change-set ของ CloudFormation และแสดงให้เห็นอย่างชัดเจนว่าทรัพยากรใดจะเปลี่ยนแปลง (โค้ด Lambda, IAM, EventBridge) — การกำหนดค่าขอบเขตของคุณจะถูกเก็บรักษาไว้ ไม่ถูกรีเซ็ต คุณต้องยืนยันก่อนที่จะดำเนินการ สำหรับการใช้งานแบบไม่โต้ตอบ (CloudShell batch) ให้รันด้วย --auto-approve ส่วน StackSet จะแสดงสรุปแบบ dry-run แทน เนื่องจาก change-set ไม่รองรับ StackSet',
